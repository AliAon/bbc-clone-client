               ...
               <div className={classes["add-post-space"]}>
                    ...
                    <Form onSubmit={submitHandler}  encType="multipart/form-data">
                        <Form.Group className="mb-3" controlId="formBasicEmail">
                            <Form.Control type="text" placeholder="Title" required={true} value={title} onChange={titleHandler} />
                        </Form.Group>
                        ...
                        <Row>
                            <Col>
                                ...
                                <Form.Select aria-label="Default select example" className="mb-3" required={true}  onChange={selectHandler}>
                                {categoryList}                                      
                                </Form.Select>
                            </Col>
                            <Col>
                                ...
                                <Form.Control type="text"  size="sm"  placeholder="Tags"  required={true} value={tag} onChange={tagHandler}/>
                                </Form.Group>
                            </Col>
                            <Col>
                                <Form.Label className={classes["form-label"]}>Featured Image</Form.Label>
                                <Form.Group controlId="formFile" className="mb-3">
                                <Form.Control type="file"  size="sm" required={true}  onChange={fileHandler}/>
                                </Form.Group>
                            </Col>
